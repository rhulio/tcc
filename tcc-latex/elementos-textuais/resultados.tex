...
Com o objetivo de exemplificar a aquisição de dados através do protocolo \gls{HTTP} e uma possível integração entre o sistema \gls{SCADA} proposto e outros sistemas já existentes no local em que seja utilizado, foi desenvolvido um código utilizando a linguagem de programação PHP, disponível no anexo \ref{an:anexo-roteadores}, para o monitoramento de 11 roteadores dispostos no Entre Rios Hotel na cidade de Picos - Piauí. A ideia deste exemplo é ter um histórico de demanda de hóspedes conectados e a máxima largura de banda utilizada em cada um dos roteadores num período de 24 horas, que se situam em locais distintos. Com isso, é possível a reorganização destes aparelhos para um melhor atendimento dos clientes, considerando que haja uma maior demanda na maior parte do tempo em um zona específica do hotel.
        ...
        \begin{figure}[!h]
		\Caption{\label{fig:figura-incubadora-temperatura} Variáveis utilizadas no projeto.}
		%\centering
		\UFCfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/incubadora-temperatura.png}}
		}{
			\Fonte{O autor}
		}	
    	\end{figure}
        ...
        \begin{figure}[!h]
		\Caption{\label{fig:figura-incubadora-temperatura-cupula} Variáveis utilizadas no projeto.}
		%\centering
		\UFCfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/incubadora-temperatura-cupula.png}}
		}{
			\Fonte{O autor}
		}	
    	\end{figure}
    	...
    	\begin{figure}[!h]
		\Caption{\label{fig:figura-incubadora-temperatura-externa} Variáveis utilizadas no projeto.}
		%\centering
		\UFCfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/incubadora-temperatura-externa.png}}
		}{
			\Fonte{O autor}
		}	
    	\end{figure}
    	...
    	\begin{figure}[!h]
		\Caption{\label{fig:figura-incubadora-umidade} Variáveis utilizadas no projeto.}
		%\centering
		\UFCfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/incubadora-umidade.png}}
		}{
			\Fonte{O autor}
		}	
    	\end{figure}
